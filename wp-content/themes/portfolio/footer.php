<footer>
    ...
    <div class="slider">
        <div class="slide-track">
            <div class="slide">
                <img src="<?= get_stylesheet_directory_uri() ?>\img\dino1.svg" class="dino" height="100" width="250" alt="" />
            </div>

            <div class="slide">
                <img src="<?= get_stylesheet_directory_uri() ?>\img\work_together.png" class="letswork" height="100" width="250" alt="" />
            </div>
            ...
            <div class="slide">
                <img src="<?= get_stylesheet_directory_uri() ?>\img\work_together.png" height="100" width="250" alt="" />
            </div>
    ...
    <p class="rights">@All rights reserved to Mathilde Vauquieres 2022</p>
